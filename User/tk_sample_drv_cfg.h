...
******************************************************************************/
#ifndef TK_SAMPLE_DRV_CFG_H
#define TK_SAMPLE_DRV_CFG_H
...
#define CAN_CFG_RXFIFO0 \
    CAN_CFG_RXFIFO(CAN_FIFO_DEPTH_8, CAN_DISABLE, \
                   CAN_FIFO_INT_THRESHOLD, CAN_FIFO_THRESHOLD_FULL) 
...
#define CAN_CFG_C0_BAUDRATE_H \
    CAN_CFG_BAUDRATEH(CAN_TSEG1_11TQ, CAN_TSEG2_4TQ, CAN_SJW_4TQ)
