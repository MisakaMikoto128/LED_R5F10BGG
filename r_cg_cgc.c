...
void R_CGC_Create(void)
{
    ...
    SELLOSC = 0U;
    /* Set fMX */
    CMC = _40_CGC_HISYS_OSC | _10_CGC_SUB_OSC | _00_CGC_SYSOSC_UNDER10M | _02_CGC_SUBMODE_NORMAL;
    ...
    /* Set fPLL */
    PLLCTL = _80_CGC_LOCKUP_WAIT_9 | _20_CGC_PLL_ABOVE_32MHZ | _00_CGC_PLL_DIVISION_2 | _02_CGC_PLL_MULTIPLY_X16;
